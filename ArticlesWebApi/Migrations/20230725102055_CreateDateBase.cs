    ...
    public partial class CreateDateBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticalFavorites", x => new { x.ArticleId, x.UsertId });
                    table.ForeignKey(
                        name: "FK_ArticalFavorites_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ArticalFavorites_Users_UsertId",
                        column: x => x.UsertId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticalFavorites_UsertId",
                table: "ArticalFavorites",
                column: "UsertId");
